...
In this paper, we experimentally test the impact of gene duplication on evolution of structural and functional complexity, and the extent to which such impact depends on the actual genetic information content within duplications.
...
Digital evolution experiments were conducted using the Avida platform.
