...
existing theory identifies gene duplication as one prime suspect \citep{Zhang2003,Otto2000,Wagner2008,Crow:2006role,Magadum:2013wu,Metz:chromosomeDuplication1947,Hu:2010ea,Castellanos2024,Lynch2000b,Lynch2003,Birchler2022}.
While comparative studies provide increasingly detailed accounts of duplication events shaping specific evolved traits \citep{Zhang2014,teichmann_structural_1998,Teichmann:2004cz,DuBose2024,Voordeckers2012,Pougach2014,Moore2003,Ogino2015,Tasnim2024,Assis2013,Deng2010,Monson2003,Xue2026,Lynch2007Inventing}, work remains to develop systematic understanding \citep{Welch2016} of gene duplication's broader role in both adaptive and neutral evolutionary processes \citep{Innan2010,Zhang:2003fw,Kuzmin2022}.
In this paper, we evaluate the impact of gene duplication on evolution of structural and functional complexity, and the extent to which such impact depends on the actual genetic information content within duplications.
...
In recent years, such experimental approaches --- which directly test evolutionary causality --- have become an important complement to observational studies of natural history \citep{Kawecki2012,Elena2003}.
...
Our digital experiments were conducted using the Avida platform.
This software administers populations of self-replicating computer programs, operating as digital ``model organisms'' \citep{Ofria:2009avida}.
...
Under this framework, input/output calculations are considered as phenotypic traits, with the complexity of a given task defined according to the minimum number of necessary substeps \citep{Lenski2003Evolutionary}.
Applying this lens, Lenski \textit{et al.} demonstrated that simpler traits could provide building blocks for complex ones --- and, in fact, often amounted to necessary prerequisites for their evolution.

To comprehensively test complexity outcomes, we additionally considered a measure of structural genetic complexity.
Here, we counted genome instructions contributing to an organism's fitness \citep{Adami2002}.
Adaptive sites were identified through single-site knockouts \citep{moreno2024cryptic}, replacing genome instructions one-by-one with no-operation stand-ins.

With respect to both two complexity metrics, we find that gene duplication can systematically increase evolved complexity.
Control treatments reveal that information content within duplicated regions acts to catalyze genome expansion.
This expansion, in turn, suffices to promote simple adaptive traits and increased coding site count --- in line with neutralist explanations for biological complexity \citep{Lynch2000,Beslon2021,Lynch2007}
However, we also find that information content within duplicated regions acts to catalyze complex traits, beyond the effects of increased genome size alone.
Disproportionate coding sites for complex traits, in fact, trace back to slip-duplicated regions.
Gene duplication thus also systematically promotes complex functional innovation in adaptation-driven scenarios.
...
Under this scheme, organisms producing correct output values for a task benefit by accelerating their genetic operations, analogous to metabolism.
...
To control for the effects of genome length, we also included trials with longer 1,000-site genomes, which was near the upper extreme of 870-site genome length observed in slip-duplication experiments (Supplementary Figure \ref{fig:ablation-site-counts}).
