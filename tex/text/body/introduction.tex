...
While by necessity substantially abstracting some aspects of biological organisms \citep{peck2004simulation}, \textit{in silico} experiments on the other hand support principled definitions of complexity \citep{Adami2002}, fast throughput spanning thousands of generations, and flexible exploration of arbitrary counterfactuals \citep{langton1989artificial}.
