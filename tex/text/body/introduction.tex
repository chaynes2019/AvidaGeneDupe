...
Other research using Avida has yielded wide-ranging contributions, shedding light on how selection influences information-theoretic measures of genome complexity \citep{Adami2000Evolution}, co-evolutionary pressures for complexity \citep{Zaman2014Coevolution}, and the abundance of possible genetic encodings for complex phenotypes \citep{Fortuna2017GenotypePhenotype}.

To determine the role of adaptation in complexity arising from gene duplication, we independently assessed the influence of slip-duplication mutations on both genetic and phenotypic complexity.
