...
Despite this similarity, however, when including sites with earlier phenotypic contribution (i.e., ``vestigial'' coding sites), we found a significantly increased coding site count associated with the slip-duplicate treatment (Mann-Whitney test, $U=630$, $p<0.01$).
