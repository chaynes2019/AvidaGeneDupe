...
We conducted experiments using a custom version of Avida v2.14.0, extended to implement gene duplication \citep{Ofria:2009avida}.
...
Avida genomes are linear sequences of instructions, each encoding one of 27 available operations for basic computations, execution flow control, input and output, and self-replication.
