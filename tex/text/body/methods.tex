...
Run length was 200,000 ``updates'' across all experiments, a unit of simulation time equivalent to the time required for an organism to execute 30 instructions.
...
This strategy was necessary to account for the long-genome controls elapsing on the order of 10$\times$ fewer generations than baseline conditions, on account of self-replication proceeding slower with more genome content.
...
Thus, even when comparing by update in these other experiments, acceleration of adaptation under slip duplication could not be have been caused by more generations elapsing under the slip-duplication treatment.
