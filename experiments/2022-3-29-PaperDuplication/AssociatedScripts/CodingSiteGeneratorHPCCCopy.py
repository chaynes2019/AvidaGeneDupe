...
def getLength(runDir, lineageGenerationIndex):
    replicateData = os.path.join(runDir, f'Timepoint_{desiredUpdateToAnalyze}/detail_MostNumLineageAt{desiredUpdateToAnalyze}.dat')
...
def createDatAnalyzeCfg(runDir):
        ...
        datFile = os.path.join(datDir,f"detail_MostNumLineageAt{desiredUpdateToAnalyze}.dat")
