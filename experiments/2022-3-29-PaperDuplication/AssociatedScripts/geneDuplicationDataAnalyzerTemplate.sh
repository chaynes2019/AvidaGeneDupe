...
do
    ...
    EXECUTE="avida -s $${SEED} -set COPY_MUT_PROB 0.0025 -set COPY_INS_PROB 0.0 -set COPY_DEL_PROB 0.0 -set DIVIDE_INS_PROB 0.00 -set DIVIDE_DEL_PROB 0.00 -set DIVIDE_SLIP_PROB $divSlipProb -set SLIP_FILL_MODE $slipFillMode"
