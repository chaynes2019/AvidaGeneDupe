...
do
    ...
    EXECUTE="avida -s $${SEED} -set COPY_MUT_PROB 0.0 -set DIVIDE_POISSON_MUT_MEAN 0.25 -set COPY_INS_PROB 0.0 -set COPY_DEL_PROB 0.0 -set DIVIDE_INS_PROB 0.05 -set DIVIDE_DEL_PROB 0.05 -set DIVIDE_SLIP_PROB $divSlipProb -set SLIP_FILL_MODE $slipFillMode -set STERILIZE_UNSTABLE 1 -set EVENT_FILE $eventFile"
